...
public class Program {
    ...
    private static short studentsNameIndex = 0;

    private static final short STUDENT_INSERT_SUCCESS = 0;
    private static final short STUDENT_ALREADY_EXIST = 1;
    private static final short STUDENTS_MAX = 2;
    private static final short STUDENTS_MAX_LENGTH = 3;
    private static final short STUDENT_NAME_NOT_ALPHA = 4;

    private static final short HERE = 1;
    private static final short NOT_HERE = 2;
    ...
    public void solve() {
        final short NAMES = 0;
        final short CLASSES = 1;
        final short ATTENDANCE = 2;
